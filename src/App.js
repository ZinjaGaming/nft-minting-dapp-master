...
There was once a little shepherd, who lived in a little village at the foot of a mountain, with green meadows and a plentiful river. But it wasn’t just the beautiful nature that made the village a charming place, it was also the kindness of its one hundred inhabitants.
<br></br><br></br>
The little shepherd was always with the flock of sheep, a dog and a little donkey. Every day before the sun came up, the little shepherd was already ready to milk the sheeps and then go out onto the meadows with them.
<br></br><br></br>
Although was a little older now, the little shepherd still spent all day outside, returning just before it grew dark. Being a shepherd was indeed a very selfless job, for you needed to be strong and fit to spend all day every day walking through the fields. And there was the milking to be done too.
<br></br><br></br>
Whenever there was too much milk from milking the sheeps, the little shepherd would usually share it out among the villagers.      
</s.TextP>
            </s.SecContainer>
    ...
    <Panel header="What is Wonder Sheep?">
    <s.TextP style={{textAlign: "left"}}>
    Created by TeamZinja, Wonder Sheep is a series of 500 on-chain NFT collectibles that provide membership and access to different kinds of metaversal experiences. Every Wonder Sheep is a piece of an art in its own right and has varying traits and accessories.
          </s.TextP>
    </Panel>
    <Panel header="What is the team background?">
    <s.TextP style={{textAlign: "left"}}>
    This project is only made by two people, me and my wife. We are from the Philippines. Although the design is made by my wife, almost everything is done by me from generating NFT to deploying smart contract. So its almost a one-man team project, and to clarify that I also not a great coder, I made everything from open-source script and watching a lot of tutorial (I mean a LOT!)
          </s.TextP>
    </Panel>
    <Panel header="What are your goals for the project?">
    <s.TextP style={{textAlign: "left"}}>
    My fundamental mission is to build a community not only on Polygon, but for the entire chain. Create a opportunities for the holders, build knowledge, develop skills and make a connection in web3. I believe that a great community is the key to success in crypto space.
          </s.TextP>
    </Panel>
    <Panel header="How much will each Wonder Sheep cost to mint?">
    <s.TextP style={{textAlign: "left"}}>
    2 Matic
          </s.TextP>
    </Panel>
    <Panel header="Will there be a gated community?">
    <s.TextP style={{textAlign: "left"}}>
    Yes!
          </s.TextP>
    </Panel>
